    ...
    impl From<Reverb> for &'static str {
        fn from(reverb: Reverb) -> &'static str {
            match reverb {
                ...
                Reverb::HighlyDampedLargeRoom => {
                    "assets/internal/reverbs/highly_damped_large_room.wav"
                }
                ...
                Reverb::SmallPrehistoricCave => {
                    "assets/internal/reverbs/small_prehistoric_cave.wav"
                }
